...
mixin _$Note {
  ...
  NotesBody get body => throw _privateConstructorUsedError;
...
abstract class $NoteCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {UniqueId id, NotesBody body, NoteColor color, List3<TodoItem> todos});
}
